...
@Liveness
@ApplicationScoped
public class GetPlaylistCheck implements HealthCheck {
    ...
    public HealthCheckResponse call() {
        ...
        try {
            ...
            return HealthCheckResponse.named("2 - " + GetPlaylistCheck.class.getSimpleName() + " - Liveness").up().build();
        } catch(Exception e){
            return HealthCheckResponse.named("2 - " + GetPlaylistCheck.class.getSimpleName() + " - Liveness").down().build();
        }
    }
}
